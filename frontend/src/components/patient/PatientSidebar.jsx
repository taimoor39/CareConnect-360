...
function PatientSidebar({ patient }) {
  ...
  return (
    <aside className="sticky top-0 hidden h-screen w-[17.5rem] shrink-0 flex-col border-r border-slate-800/60 bg-slate-950/90 px-4 py-8 backdrop-blur-xl lg:flex">
      <div className="px-1">
